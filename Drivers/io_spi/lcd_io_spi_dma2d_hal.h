...
/* Features:
   ...
   - read function 8 and 16bit with DMA
   - read function with bitdepth convert (24bit RGB888 to 16bit RGB565) with DMA */
...
/* Pixel buffer size for DMA2D bitdepth conversion (buffer size [byte] = 3 * pixel buffer size) */
